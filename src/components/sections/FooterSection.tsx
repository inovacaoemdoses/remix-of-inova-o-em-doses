...
const FooterSection = () => {
  ...
  const socialLinks = [
    { 
      name: "Instagram", 
      url: "https://www.instagram.com/inovacaoemdoses/", 
      icon: Instagram 
    },
    { 
      name: "YouTube", 
      url: "https://www.youtube.com/@Inovacaoemdoses", 
      icon: Youtube 
    },
    { 
      name: "TikTok", 
      url: "https://www.tiktok.com/@inovacaoemdoses", 
      icon: () => (
    ...
    { 
      name: "Spotify", 
      url: "https://open.spotify.com/show/1uDKzxeF1Z2nRq8TaTv1pO", 
      icon: () => (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
